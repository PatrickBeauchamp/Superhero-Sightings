<%-- 
    ...
    Created on : Oct 24, 2018, 9:37:26 AM
    Author     : patty
--%>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" role="form" method="POST" action="editLocation">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="description" placeholder="${location.description}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="add-street" class="col-md-4 control-label">Street Address: </label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="street" placeholder="${location.street}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="add-city" class="col-md-4 control-label">City: </label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="city" placeholder="${location.city}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="add-state" class="col-md-4 control-label">State: </label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="state" placeholder="${location.state}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="add-state" class="col-md-4 control-label">Postal Code: </label>
                    <div class="col-md-8">
                        <input type="number" class="form-control" name="zip" placeholder="${location.zip}"/>
                    </div>
                </div>
