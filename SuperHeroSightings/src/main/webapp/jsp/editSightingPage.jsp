<%-- 
    Document   : editSightingPage
    Created on : Oct 28, 2018, 12:36:22 PM
    Author     : patty
--%>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" role="form" method="POST" action="editSighting">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="date" class="form-control" placeholder="sighting.date"value="${sighting.date}" readonly/>
                    </div>
                </div>
                <div class="form-group">
                    <label for=date" class="col-md-4 control-label">Edit Date: </label>
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <label for="add-mutant" class="col-md-4 control-label">Edit Mutant(s): </label>
                    <div class="col-md-8">
                        <select class="selectpicker" multiple data-live-search="true" name="mutants">
                ...
                <div class="form-group">
                    ...
                    <label for="add-location" class="col-md-4 control-label">Edit Location: </label>
                    <div class="col-md-8">
