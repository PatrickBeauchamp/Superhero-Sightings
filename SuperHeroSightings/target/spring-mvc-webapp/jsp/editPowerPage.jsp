<%-- 
    Document   : editPowerPage
    Created on : Oct 24, 2018, 8:48:41 AM
    Author     : patty
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <h2>Edit a Power</h2>
                    <form class="form-horizontal" role="form" method="POST" action="editPower">
                        <div class="form-group">
                            <label for="add-description" class="col-md-4 control-label">Power Description</label>
                            <div class="col-md-8">
                                <input type="hidden" name="powerId" value="${power.id}"/>
